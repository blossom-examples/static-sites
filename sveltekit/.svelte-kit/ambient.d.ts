...
declare module '$env/static/private' {
	...
	export const CLOAKER_KEY: string;
	export const USER: string;
	export const TS_TOKEN: string;
	...
	export const CLOAKER_KEY_PATH: string;
	...
	export const ASDF_GOLANG_MOD_VERSION_ENABLED: string;
	export const TERM: string;
	export const XDG_SESSION_ID: string;
	export const OVERCOMMIT_DISABLE: string;
	...
	export const GOOGLE_PROJECT: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		ASDF_GOLANG_MOD_VERSION_ENABLED: string;
		TERM: string;
		XDG_SESSION_ID: string;
		OVERCOMMIT_DISABLE: string;
